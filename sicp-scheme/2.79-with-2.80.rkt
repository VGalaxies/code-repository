...
(module* main #f
  ...
  (equ? (make-complex-from-real-imag 10 20) (make-complex-from-real-imag 10 20))
  (equ? (make-complex-from-mag-ang 10 3.1415926) (make-complex-from-mag-ang 10 3.1415926))
